...
class mapOptimization : public ParamServer
{
    public:
        ...
        mapOptimization(const rclcpp::NodeOptions & options) : ParamServer("lvi_sam_mapOptimization",options)
        {
            ...
            subLaserCloudInfo   = this->create_subscription<lvi_sam::msg::CloudInfo>(PROJECT_NAME + "/lidar/feature/cloud_info", 5,std::bind(&mapOptimization::laserCloudInfoHandler, this,std::placeholders::_1));
            subGPS              = this->create_subscription<nav_msgs::msg::Odometry>(gpsTopic,50,std::bind(&mapOptimization::gpsHandler, this,std::placeholders::_1));
            subLoopInfo         = this->create_subscription<std_msgs::msg::Float64MultiArray>(PROJECT_NAME + "/vins/loop/match_frame", 5,std::bind(&mapOptimization::loopHandler, this,std::placeholders::_1));
        ...
        void performLoopClosure(const std_msgs::msg::Float64MultiArray& loopMsg)
        {
        ...
        void loopFindKey(const std_msgs::msg::Float64MultiArray& loopMsg, 
        ...
        void publishOdometry()
        {
            ...
            trans_odom_to_lidar.transform.translation.x =  tf2::Vector3(transformTobeMapped[3], transformTobeMapped[4], transformTobeMapped[5]).x();
            trans_odom_to_lidar.transform.translation.y =  tf2::Vector3(transformTobeMapped[3], transformTobeMapped[4], transformTobeMapped[5]).y();
            trans_odom_to_lidar.transform.translation.z =  tf2::Vector3(transformTobeMapped[3], transformTobeMapped[4], transformTobeMapped[5]).z();
            tf2::Quaternion q;
            q.setRPY(transformTobeMapped[0], transformTobeMapped[1], transformTobeMapped[2]);
            trans_odom_to_lidar.transform.rotation.x = q.x(); 
            trans_odom_to_lidar.transform.rotation.y = q.y();
            trans_odom_to_lidar.transform.rotation.z = q.z();
            trans_odom_to_lidar.transform.rotation.w = q.w();
...
{    
    ...
    RCLCPP_INFO(rclcpp::get_logger("LIS_mapOptimization_Node"),"\033[1;32m----> Lidar Map Optimization Started.\033[0m");
