...
{
    RCLCPP_DEBUG(rclcpp::get_logger("feature_manager.cpp"),"input feature: %d", (int)image.size());
    RCLCPP_DEBUG(rclcpp::get_logger("feature_manager.cpp"),"num of feature: %d", getFeatureCount());
    ...
    {
        RCLCPP_DEBUG(rclcpp::get_logger("feature_manager.cpp"),"parallax_sum: %lf, parallax_num: %d", parallax_sum, parallax_num);
        RCLCPP_DEBUG(rclcpp::get_logger("feature_manager.cpp"),"current parallax: %lf", parallax_sum / parallax_num * FOCAL_LENGTH);
...
{
    RCLCPP_DEBUG(rclcpp::get_logger("feature_manager.cpp"),"debug show");
    for (auto &it : feature)
    {
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("feature_manager.cpp"),"%d,%d,%d ", it.feature_id, it.used_num, it.start_frame);
        int sum = 0;
        for (auto &j : it.feature_per_frame)
        {
            RCLCPP_DEBUG(rclcpp::get_logger("feature_manager.cpp"),"%d,", int(j.is_used));
            sum += j.is_used;
