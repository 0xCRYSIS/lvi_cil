...
class IMUPreintegration : public ParamServer
{
    public:
        ...
        IMUPreintegration(const rclcpp::NodeOptions& options) : ParamServer("lvi_sam_imuPreintegration",options)
        {
            ...
            subImu = this->create_subscription<sensor_msgs::msg::Imu>(imuTopic,2000,std::bind(&IMUPreintegration::imuHandler,this,std::placeholders::_1));
            subOdometry = this->create_subscription<nav_msgs::msg::Odometry>(PROJECT_NAME + "/lidar/mapping/odometry", 5,std::bind(&IMUPreintegration::odometryHandler,this,std::placeholders::_1));
            ...
            // this part is done in imuHandler()
        ...
        void imuHandler(const sensor_msgs::msg::Imu::SharedPtr imuMsg)
        {
            ...
            geometry_msgs::msg::TransformStamped map_to_odom;
            map_to_odom.header.stamp = thisImu.header.stamp;
            map_to_odom.header.frame_id = "map";
            map_to_odom.child_frame_id = "odom";
            map_to_odom.transform.translation.x = tf2::Vector3(0,0,0).x();
            map_to_odom.transform.translation.y = tf2::Vector3(0,0,0).y();
            map_to_odom.transform.translation.z = tf2::Vector3(0,0,0).z();
            tf2::Quaternion q;
            q.setRPY(0,0,0);
            ...
            if (imuTime - last_path_time > 0.1)
            {
                ...
                while(!imuPath.poses.empty() && abs(stamp2Sec(imuPath.poses.front().header.stamp) - stamp2Sec(imuPath.poses.back().header.stamp)) > 3.0)
            ...
            odom_2_baselink.transform.rotation.x = odometry.pose.pose.orientation.x;
            odom_2_baselink.transform.rotation.y = odometry.pose.pose.orientation.y;
            odom_2_baselink.transform.rotation.z = odometry.pose.pose.orientation.z;
            odom_2_baselink.transform.rotation.w = odometry.pose.pose.orientation.w;
...
int main(int argc , char** argv)
{
    ...
    RCLCPP_INFO(rclcpp::get_logger("LIS_IMU_Preintegration_Node"),"\033[1;32m----> Lidar IMU Preintegration Started.\033[0m");
